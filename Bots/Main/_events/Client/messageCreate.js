...
class messageCreate extends Event {
 ...
 async onLoad(message) {
        if (message.author.bot || !client.prefix.some(x => message.content.startsWith(x))||(!client.owners.includes(message.author.id) )  || !message.channel || message.channel.type != 0) return;
